...
<h1 bs-heading=""><svg bs-svg-icon="">
<use xlink:href="#svg-help"></use>
</svg> Help / About</h1>
</div>
<div bs-panel="">
<div bs-panel-content="basic">
<p class="lede">Browsersync is an open-source project created and maintained by the front-end designers/developers at <a href="http://www.wearejh.com">JH</a> . Together with contributors from all over the world, we aim to make modern, multi-device web development faster & easier.</p>
</div>
</div>
<div bs-panel="">
<div bs-panel-content="basic">
...
<dd>99% of the time, it's because your web page doesn't have a <code>body</code> tag. In order for Browsersync to connect properly the <code>body</code> tag must be present in your website (we add a script tag just after it). Alternatively you can provide a custom rule for the snippet using <a href="http://www.browsersync.io/docs/options/#option-snippetOptions">snippetOptions</a></dd>
...
<li>If you intend to copy/paste the snippet into your website manually, you use the <code>snippet</code> mode. This is the default mode and is achieved by omitting both the server & proxy options</li>
</ul>
</dd>
